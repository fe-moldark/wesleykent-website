...
<br>
As you can tell, this is far from any kind of "official" enclosure, rather it is just some pieces of wood that keeps the temperature high enough inside for those annoying filaments like ABS. With the fan / filter running the enclosure reaches a maximum of 105°F from what I've observed. I've also brought out some power and ground wires from the printer's PSU and that is running the LED strip you can see in the image. The power wire is first routed through a toggle switch on the side for easy on / off control.
<br><br>
